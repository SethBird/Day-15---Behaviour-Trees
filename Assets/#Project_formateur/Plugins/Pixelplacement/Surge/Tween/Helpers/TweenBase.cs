...
namespace Pixelplacement.TweenSystem
{
    ...
    {
        //Public Variables:
        public EntityId targetInstanceID;
        ...
        /// </summary>
        protected void SetEssentials (Tween.TweenType tweenType, EntityId targetInstanceID, float duration, float delay, bool obeyTimeScale, AnimationCurve curve, Tween.LoopType loop, Action startCallback, Action completeCallback)
        {
