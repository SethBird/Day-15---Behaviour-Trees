...
using Action = Unity.Behavior.Action;
    ...
    [NodeDescription(
        ...
        id: "3bc19d3122374cc9a985d90351633311")]
    public partial class NavigateToTarget2DAction : Action
    {
        ...
        protected override Status OnUpdate()
        {
            ...
            {
                m_CurrentSpeed = NavigationUtility2D.SimpleMoveTowardsLocation(Agent.Value.transform, m_ColliderAdjustedTargetPosition,
