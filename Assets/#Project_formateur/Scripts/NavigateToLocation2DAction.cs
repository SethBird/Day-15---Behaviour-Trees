...
namespace Unity.Behavior
{
    ...
    [NodeDescription(
        ...
        category: "Action/Boss Fight",
        id: "c67c5c55de9fe94897cf61976250cc84")]
    internal partial class NavigateToLocation2DAction : Action
    {
        ...
        protected override Status OnUpdate()
        {
            ...
            {
                m_CurrentSpeed = NavigationUtility2D.SimpleMoveTowardsLocation(Agent.Value.transform, locationPosition, Speed, distance, SlowDownDistance);
            }
        ...
        {
            NavigationUtility2D.UpdateAnimatorSpeed(m_Animator, AnimatorSpeedParam, m_NavMeshAgent, m_CurrentSpeed, explicitSpeed: explicitSpeed);
        }
    }
}
